   ...
   <div class="row">
         ...
         <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
            ...
            <div class="p-3 position-relative">
               <div class="list-card-body">
                  ...
                  <p class="text-gray mb-3">Chay • Ấn Độ • Thuần Chay</p>
               ...
               <div class="list-card-badge">
                  <span class="badge badge-danger">ƯU ĐÃI</span> <small> Sử dụng Mã OSAHAN50</small>
               </div>
            </div>
         </div>
      </div>
      <div class="col-md-4 col-sm-6 mb-4 pb-2">
         <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
            ...
            <div class="p-3 position-relative">
               <div class="list-card-body">
                  <h6 class="mb-1"><a href="detail.html" class="text-black">Ẩm Thực Thái Nổi Tiếng</a></h6>
               ...
               <div class="list-card-badge">
                  <span class="badge badge-success">ƯU ĐÃI</span> <small>Giảm 65%</small>
               </div>
            </div>
         </div>
      </div>
      <div class="col-md-4 col-sm-6 mb-4 pb-2">
         <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
            ...
            <div class="p-3 position-relative">
               ...
               <div class="list-card-badge">
                  <span class="badge badge-danger">ƯU ĐÃI</span> <small>Giảm 65% OSAHAN50</small>
               </div>
            </div>
         </div>
      </div>
      <div class="col-md-4 col-sm-6 mb-4 pb-2">
         <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
            ...
            <div class="p-3 position-relative">
               ...
               <div class="list-card-badge">
                  <span class="badge badge-danger">ƯU ĐÃI</span> <small>Giảm 65% Mã OSAHAN50</small>
               </div>
            </div>
         </div>
      </div>
      <div class="col-md-4 col-sm-6 mb-4 pb-2">
         <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
            ...
            <div class="p-3 position-relative">
               ...
               <div class="list-card-badge">
                  <span class="badge badge-danger">ƯU ĐÃI</span> <small> Mã OSAHAN50</small>
               </div>
            </div>
         </div>
      </div>
      <div class="col-md-4 col-sm-6 mb-4 pb-2">
         <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
            ...
            <div class="p-3 position-relative">
               ...
               <div class="list-card-badge">
                  <span class="badge badge-danger">Ưu Đãi</span> <small> Giảm 65%</small>
               </div>
            </div>
         </div>
      </div>
